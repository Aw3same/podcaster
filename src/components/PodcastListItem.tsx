...
export function PodcastListItem({podcast}: {podcast: Entry}) {
    ...
    <Link to={`/podcast/${podcast.id.attributes['im:id']}`} className="flex flex-col justify-center items-center w-full max-w-xs p-3 border border-gray-300 rounded-lg shadow-lg">
